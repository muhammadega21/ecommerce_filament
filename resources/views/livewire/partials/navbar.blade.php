<header
    class="flex z-999 sticky top-0 flex-wrap md:justify-start md:flex-nowrap w-full bg-white text-sm py-3 md:py-0 dark:bg-gray-800 shadow-md">
        ...
        <div class="relative md:flex md:items-center md:justify-between">
            <div class="flex items-center justify-between">
                <a class="flex-none text-xl font-semibold dark:text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                    href="{{ route('home') }}" aria-label="Brand">DCodeMania</a>
                <div class="md:hidden">
                    <button type="button"
                        ...
                        <svg class="hs-collapse-open:hidden shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg"
                        ...
                        <svg class="hs-collapse-open:block hidden shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg"
                            width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                            stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M18 6 6 18" />
                            <path d="m6 6 12 12" />
            ...
            <div id="navbar-collapse-with-animation"
                ...
                <div
                    ...
                    <div
                        ...
                        <a class="font-medium {{ Route::is('home') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }} py-3 md:py-6 "
                            href="{{ route('home') }}" wire:navigate>Home</a>

                        <a class="font-medium {{ Route::is('categories') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }}  py-3 md:py-6"
                            href="{{ route('categories') }}" wire:navigate>
                            Categories
                        </a>

                        <a class="font-medium {{ Route::is('products') ? 'text-blue-600 dark:text-blue-500' : 'text-gray-500 dark:text-gray-400' }}  py-3 md:py-6"
                        ...
                        <a class="font-medium flex items-center text-gray-500 hover:text-gray-400 py-3 md:py-6 dark:text-gray-400 dark:hover:text-gray-500 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                stroke-width="1.5" stroke="currentColor" class="shrink-0 w-5 h-5 mr-1">
                        ...
                        <div class="pt-3 md:pt-0">
                            <a class="py-2.5 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                                ...
                                <svg class="shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24"
